						...
						<div class="login_box">
							...
							<div class="form">
								<form action="login" method="post">
									...
									<label>用户名称：</label>
									<input class="itxt" type="text" placeholder="请输入用户名" autocomplete="off" tabindex="1" name="username" value="${requestScope.username==null?sessionScope.user.username:requestScope.username}" />
									<br />
									<br />
									<label>用户密码：</label>
